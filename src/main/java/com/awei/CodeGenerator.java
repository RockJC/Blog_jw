...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/myblog?serverTimezone=UTC");
        ...
        globalConfig.setAuthor("jiangwei");    //设置作者
        ...
        packageInfo.setParent("com.awei");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
        ...
        strategyConfig.setInclude("blog_tag");  //设置当前参与生成的表名，参数为可变参数
